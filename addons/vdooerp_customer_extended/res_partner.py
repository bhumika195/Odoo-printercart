...
class res_partner(models.Model):
    ...
    @api.one
    @api.depends('is_default_contact','default_contact_id')
    ...
    default_contact_id = fields.Many2one('res.partner',compute='_get_comapany_chield', string='Default Contact')
